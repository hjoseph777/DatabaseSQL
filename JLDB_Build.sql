-- Setup connection and output
SET ECHO ON
SET SERVEROUTPUT ON
SET FEEDBACK ON

-- First connect to your database (replace username/password with your credentials)
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE ACCTBONUS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN RAISE; END IF;
END;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE ACCTMANAGER CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN RAISE; END IF;
END;
