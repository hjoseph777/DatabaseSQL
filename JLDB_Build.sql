...
DROP TABLE AUTHORS CASCADE CONSTRAINTS;  -- Changed from AUTHOR to AUTHORS
DROP TABLE BOOKS CASCADE CONSTRAINTS;
DROP TABLE ORDERITEMS CASCADE CONSTRAINTS;
DROP TABLE BOOKAUTHOR CASCADE CONSTRAINTS;
DROP TABLE PROMOTIONS CASCADE CONSTRAINTS;  -- Changed from PROMOTION
...
Lname VARCHAR2(10), 
Fname VARCHAR2(10),
  CONSTRAINT authors_authorid_pk PRIMARY KEY(authorid));  -- Changed constraint name
...
(ISBN VARCHAR2(10), 
 AuthorID VARCHAR2(4),
  ...
  CONSTRAINT bookauthor_authorid_fk FOREIGN KEY (authorid)
             REFERENCES authors (authorid));    -- Reference to authors table
...
CREATE TABLE promotions   -- Changed from promotion
(Gift  varchar2(15), 
 Minretail number(5,2), 
 Maxretail number(5,2)); 
 
INSERT into promotions    -- Changed from promotion
